...
namespace ToolKit
{
  ...
  UIManager::UIManager()
  {
    ...
    m_uiCamera->SetOrthographicScaleVal(1.0f);
  }
  ...
  void UIManager::UpdateLayers(float deltaTime, ViewportPtr viewport)
  {
    ...
    ObjectId attachmentSwap = NullHandle;
  ...
  void UIManager::GetLayers(ObjectId viewportId, UILayerPtrArray& layers)
  {
  ...
  void UIManager::AddLayer(ObjectId viewportId, const UILayerPtr layer)
  {
  ...
  UILayerPtr UIManager::RemoveLayer(ObjectId viewportId, ObjectId layerId)
  {
  ...
  int UIManager::Exist(ObjectId viewportId, ObjectId layerId)
  {
