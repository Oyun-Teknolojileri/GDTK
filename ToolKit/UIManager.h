...
namespace ToolKit
{
  ...
  class TK_API UILayer
  {
   ...
   public:
    ...
    ObjectId m_id;              //!< Unique layer id trough the runtime.
  ...
  class TK_API UIManager
  {
   public:
     ...
     */
    void GetLayers(ObjectId viewportId, UILayerPtrArray& layers);
     ...
     */
    void AddLayer(ObjectId viewportId, const UILayerPtr layer);
     ...
     */
    UILayerPtr RemoveLayer(ObjectId viewportId, ObjectId layerId);
