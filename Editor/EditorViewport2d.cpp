...
namespace ToolKit
{
  namespace Editor
  {
    ...
    void EditorViewport2d::AdjustZoom(float delta)
    {
      ...
      float zoom    = cam->GetOrthographicScaleVal();
      ...
      cam->SetOrthographicScaleVal(100.0f / m_zoomPercentage);
    }
    ...
    void EditorViewport2d::PanZoom(float deltaTime)
    {
      ...
      if (ImGui::IsMouseDragging(ImGuiMouseButton_Middle))
      {
        ...
        float x       = -io.MouseDelta.x * cam->GetOrthographicScaleVal();
        float y       = io.MouseDelta.y * cam->GetOrthographicScaleVal();
