...
namespace ToolKit
{
  namespace Editor
  {
    ...
    void UI::DeserializeThemeSettings(Theme theme)
    {
      ...
      ImGuiStyle& style                                = ImGui::GetStyle();
      style.Colors[ImGuiCol_Text]                      = ImVec4(colors[0].x, colors[0].y, colors[0].z, colors[0].w);
      style.Colors[ImGuiCol_TextDisabled]              = ImVec4(colors[1].x, colors[1].y, colors[1].z, colors[1].w);
      style.Colors[ImGuiCol_WindowBg]                  = ImVec4(colors[2].x, colors[2].y, colors[2].z, colors[2].w);
      style.Colors[ImGuiCol_ChildBg]                   = ImVec4(colors[3].x, colors[3].y, colors[3].z, colors[3].w);
      style.Colors[ImGuiCol_PopupBg]                   = ImVec4(colors[4].x, colors[4].y, colors[4].z, colors[4].w);
      style.Colors[ImGuiCol_Border]                    = ImVec4(colors[5].x, colors[5].y, colors[5].z, colors[5].w);
      style.Colors[ImGuiCol_BorderShadow]              = ImVec4(colors[6].x, colors[6].y, colors[6].z, colors[6].w);
      style.Colors[ImGuiCol_FrameBg]                   = ImVec4(colors[7].x, colors[7].y, colors[7].z, colors[7].w);
      style.Colors[ImGuiCol_FrameBgHovered]            = ImVec4(colors[8].x, colors[8].y, colors[8].z, colors[8].w);
      style.Colors[ImGuiCol_FrameBgActive]             = ImVec4(colors[9].x, colors[9].y, colors[9].z, colors[9].w);
      style.Colors[ImGuiCol_TitleBg]                   = ImVec4(colors[10].x, colors[10].y, colors[10].z, colors[10].w);
      style.Colors[ImGuiCol_TitleBgActive]             = ImVec4(colors[11].x, colors[11].y, colors[11].z, colors[11].w);
      style.Colors[ImGuiCol_TitleBgCollapsed]          = ImVec4(colors[12].x, colors[12].y, colors[12].z, colors[12].w);
      style.Colors[ImGuiCol_MenuBarBg]                 = ImVec4(colors[13].x, colors[13].y, colors[13].z, colors[13].w);
      style.Colors[ImGuiCol_ScrollbarBg]               = ImVec4(colors[14].x, colors[14].y, colors[14].z, colors[14].w);
      style.Colors[ImGuiCol_ScrollbarGrab]             = ImVec4(colors[15].x, colors[15].y, colors[15].z, colors[15].w);
      style.Colors[ImGuiCol_ScrollbarGrabHovered]      = ImVec4(colors[16].x, colors[16].y, colors[16].z, colors[16].w);
      style.Colors[ImGuiCol_ScrollbarGrabActive]       = ImVec4(colors[17].x, colors[17].y, colors[17].z, colors[17].w);
      style.Colors[ImGuiCol_CheckMark]                 = ImVec4(colors[18].x, colors[18].y, colors[18].z, colors[18].w);
      style.Colors[ImGuiCol_SliderGrab]                = ImVec4(colors[19].x, colors[19].y, colors[19].z, colors[19].w);
      style.Colors[ImGuiCol_SliderGrabActive]          = ImVec4(colors[20].x, colors[20].y, colors[20].z, colors[20].w);
      style.Colors[ImGuiCol_Button]                    = ImVec4(colors[21].x, colors[21].y, colors[21].z, colors[21].w);
      style.Colors[ImGuiCol_ButtonHovered]             = ImVec4(colors[22].x, colors[22].y, colors[22].z, colors[22].w);
      style.Colors[ImGuiCol_ButtonActive]              = ImVec4(colors[23].x, colors[23].y, colors[23].z, colors[23].w);
      style.Colors[ImGuiCol_Header]                    = ImVec4(colors[24].x, colors[24].y, colors[24].z, colors[24].w);
      style.Colors[ImGuiCol_HeaderHovered]             = ImVec4(colors[25].x, colors[25].y, colors[25].z, colors[25].w);
      style.Colors[ImGuiCol_HeaderActive]              = ImVec4(colors[26].x, colors[26].y, colors[26].z, colors[26].w);
      style.Colors[ImGuiCol_Separator]                 = ImVec4(colors[27].x, colors[27].y, colors[27].z, colors[27].w);
      style.Colors[ImGuiCol_SeparatorHovered]          = ImVec4(colors[28].x, colors[28].y, colors[28].z, colors[28].w);
      style.Colors[ImGuiCol_SeparatorActive]           = ImVec4(colors[29].x, colors[29].y, colors[29].z, colors[29].w);
      style.Colors[ImGuiCol_ResizeGrip]                = ImVec4(colors[30].x, colors[30].y, colors[30].z, colors[30].w);
      style.Colors[ImGuiCol_ResizeGripHovered]         = ImVec4(colors[31].x, colors[31].y, colors[31].z, colors[31].w);
      style.Colors[ImGuiCol_ResizeGripActive]          = ImVec4(colors[32].x, colors[32].y, colors[32].z, colors[32].w);
      style.Colors[ImGuiCol_InputTextCursor]           = ImVec4(colors[33].x, colors[33].y, colors[33].z, colors[33].w);
      style.Colors[ImGuiCol_TabHovered]                = ImVec4(colors[34].x, colors[34].y, colors[34].z, colors[34].w);
      style.Colors[ImGuiCol_Tab]                       = ImVec4(colors[35].x, colors[35].y, colors[35].z, colors[35].w);
      style.Colors[ImGuiCol_TabSelected]               = ImVec4(colors[36].x, colors[36].y, colors[36].z, colors[36].w);
      style.Colors[ImGuiCol_TabSelectedOverline]       = ImVec4(colors[37].x, colors[37].y, colors[37].z, colors[37].w);
      style.Colors[ImGuiCol_TabDimmed]                 = ImVec4(colors[38].x, colors[38].y, colors[38].z, colors[38].w);
      style.Colors[ImGuiCol_TabDimmedSelected]         = ImVec4(colors[39].x, colors[39].y, colors[39].z, colors[39].w);
      style.Colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(colors[40].x, colors[40].y, colors[40].z, colors[40].w);
      style.Colors[ImGuiCol_DockingPreview]            = ImVec4(colors[41].x, colors[41].y, colors[41].z, colors[41].w);
      style.Colors[ImGuiCol_DockingEmptyBg]            = ImVec4(colors[42].x, colors[42].y, colors[42].z, colors[42].w);
      style.Colors[ImGuiCol_PlotLines]                 = ImVec4(colors[43].x, colors[43].y, colors[43].z, colors[43].w);
      style.Colors[ImGuiCol_PlotLinesHovered]          = ImVec4(colors[44].x, colors[44].y, colors[44].z, colors[44].w);
      style.Colors[ImGuiCol_PlotHistogram]             = ImVec4(colors[45].x, colors[45].y, colors[45].z, colors[45].w);
      style.Colors[ImGuiCol_PlotHistogramHovered]      = ImVec4(colors[46].x, colors[46].y, colors[46].z, colors[46].w);
      style.Colors[ImGuiCol_TableHeaderBg]             = ImVec4(colors[47].x, colors[47].y, colors[47].z, colors[47].w);
      style.Colors[ImGuiCol_TableBorderStrong]         = ImVec4(colors[48].x, colors[48].y, colors[48].z, colors[48].w);
      style.Colors[ImGuiCol_TableBorderLight]          = ImVec4(colors[49].x, colors[49].y, colors[49].z, colors[49].w);
      style.Colors[ImGuiCol_TableRowBg]                = ImVec4(colors[50].x, colors[50].y, colors[50].z, colors[50].w);
      style.Colors[ImGuiCol_TableRowBgAlt]             = ImVec4(colors[51].x, colors[51].y, colors[51].z, colors[51].w);
      style.Colors[ImGuiCol_TextLink]                  = ImVec4(colors[52].x, colors[52].y, colors[52].z, colors[52].w);
      style.Colors[ImGuiCol_TextSelectedBg]            = ImVec4(colors[53].x, colors[53].y, colors[53].z, colors[53].w);
      style.Colors[ImGuiCol_TreeLines]                 = ImVec4(colors[54].x, colors[54].y, colors[54].z, colors[54].w);
      style.Colors[ImGuiCol_DragDropTarget]            = ImVec4(colors[55].x, colors[55].y, colors[55].z, colors[55].w);
      style.Colors[ImGuiCol_DragDropTargetBg]          = ImVec4(colors[56].x, colors[56].y, colors[56].z, colors[56].w);
      style.Colors[ImGuiCol_UnsavedMarker]             = ImVec4(colors[57].x, colors[57].y, colors[57].z, colors[57].w);
      style.Colors[ImGuiCol_NavCursor]                 = ImVec4(colors[58].x, colors[58].y, colors[58].z, colors[58].w);
      style.Colors[ImGuiCol_NavWindowingHighlight]     = ImVec4(colors[59].x, colors[59].y, colors[59].z, colors[59].w);
      style.Colors[ImGuiCol_NavWindowingDimBg]         = ImVec4(colors[60].x, colors[60].y, colors[60].z, colors[60].w);
      style.Colors[ImGuiCol_ModalWindowDimBg]          = ImVec4(colors[61].x, colors[61].y, colors[61].z, colors[61].w);
    }
    ...
    void UI::EndUI()
    {
      ...
      if (m_firstFrame)
      {
        ...
        for (WindowPtr wnd : GetApp()->m_windows)
        {
          if (wnd->_hadFocus)
          {
            ImGui::SetWindowFocus(wnd->m_name.c_str());
          }
        }
      }
    ...
    void UI::ShowSearchForFilesWindow()
    {
      ...
      if (ImGui::BeginPopupModal("SearchFile", NULL, ImGuiWindowFlags_AlwaysAutoResize))
      {
        ...
        // Begin child window with height limit and scrollbar
