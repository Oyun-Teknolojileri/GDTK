...
namespace ToolKit
{
  namespace Editor
  {
    ...
    TKDefineAbstractClass(EditorBillboardBase, Billboard);
    ...
    void EditorBillboardBase::Generate()
    {
      ...
      matPtr->UnInit();
      matPtr->SetDiffuseTextureVal(m_iconImage);
      matPtr->SetBlendState(BlendFunction::SRC_ALPHA_ONE_MINUS_SRC_ALPHA);
