  ...
  namespace Editor
  {
    ...
    void Grid::Resize(UVec2 size, AxisLabel axis, float cellSize, float linePixelCount)
    {
      ...
      VertexArray quadVertexBuffer;
      {
        ...
        quadVertexBuffer[0].tan  = Vec4(1.0f, 0.0f, 0.0f, 1.0f);
        ...
        quadVertexBuffer[1].tan  = Vec4(1.0f, 0.0f, 0.0f, 1.0f);
        ...
        quadVertexBuffer[2].tan  = Vec4(1.0f, 0.0f, 0.0f, 1.0f);
        ...
        quadVertexBuffer[5].tan  = Vec4(1.0f, 0.0f, 0.0f, 1.0f);
      }
    ...
    void Grid::Init()
    {
      ...
      if (!GetMaterialManager()->Exist(g_gridMaterialName))
      {
        ...
        GridFragmentShaderPtr frag = MakeNewPtr<GridFragmentShader>();
        frag->Load();
        GetShaderManager()->Manage(frag);

        shaderMaterial->SetFragmentShaderVal(frag);
        shaderMaterial->Init();
