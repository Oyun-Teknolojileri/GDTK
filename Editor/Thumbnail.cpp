...
namespace ToolKit
{
  namespace Editor
  {
    ...
    RenderTargetPtr ThumbnailRenderer::RenderThumbnail(Renderer* renderer, const DirectoryEntry& dirEnt)
    {
      ...
      {
        m_params.postProcessSettings->SetSSAOEnabledVal(false);
      ...
      {
        m_params.postProcessSettings->SetBloomEnabledVal(false);
        m_params.postProcessSettings->SetSSAOEnabledVal(false);
