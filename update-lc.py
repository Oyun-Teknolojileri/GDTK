...
# Define the directories to start the search from
root_directories = ['./ToolKit', './Editor', './Import', './Packer', './Workspace', './Launcher', './Templates']
...
# Recursively traverse through each directory structure
for root_directory in root_directories:
    if not os.path.isdir(root_directory):
        logger.warning(f"Skipping missing directory: {root_directory}")
        continue
